...
<html lang="en">
  <head>
    <title>Monis Ali Portfolio</title>
    <meta charset="utf-8">
...
.zoom-effect:hover {
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light site-navbar-target" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">Monis Ali</a>
	          ...
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex  align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
			            ...
			            <h1 class="mb-4 mt-3">I'm <span>Monis Ali</span></h1>
						...
						<br>
			            <h2>Data Analyst</h2>
						<!-- <h2 class="d-flex" style="margin-bottom: 0">With over 1 year of experience</h2> -->
						<!-- <br> -->
			            <p><a href="https://www.youtube.com/@monisali_official_30" target ="_blank" class="btn btn-primary py-3 px-4">YouTube</a> 
							<!-- <a href="https://github.com/monisali-git" class="btn btn-white btn-outline-white py-3 px-4">My works</a></p> -->
		            </div>
		          </div>
	        	</div>
	        </div>
						...
						<div class="img-about img d-flex align-items-stretch">
							<div class="overlay">
								<div class="row">
									...
									<div class="col-sm-6 col-md-7">
									  <div class="about-info">
										<p><span class="title-s">Name: </span> <span>Monis Ali</span></p>
										<p><span class="title-s">Job Role: </span> <span>Senior Data Analyst</span></p>
										<p><span class="title-s">Experience: </span> <span>1 Year 6 Months</span></p>
										<p><span class="title-s">Address: </span> <span>Bhubaneswar, Odisha, India</span></p>
									  </div>
									</div>
								  </div>
								...
								<div class="skill-mf">
									...
									<span>Power BI</span> <span class="pull-right">95%</span>
									<div class="progress">
									...
									<span>Microsoft Excel</span> <span class="pull-right">85%</span>
									<div class="progress">
										<div class="progress-bar" role="progressbar" style="width: 85%" aria-valuenow="85" aria-valuemin="0"
											aria-valuemax="100"></div>
									</div>
					...
					<div class="col-md-6 col-lg-7 pl-lg-5 pb-5">
						<div class="row justify-content-start pb-3">
							<div class="col-md-12 heading-section ftco-animate">
								...
								<p>With over 1 year of comprehensive experience in the field of data science & analytics, accompanied by a bachelor's degree in engineering. 
								...
								<ul class="about-info mt-4 px-md-0 px-2">
									...
									<li class="d-flex"><span>Education:</span> <span>Bachelor of Arts</span></li>
									<li class="d-flex"><span>Language:</span> <span>English, Hindi, Urdu, Odia</span></li>
									<li class="d-flex"><span>BI Tools:</span> <span>Microsoft Power BI, MS Excel &amp; Tableau</span></li>
									<li class="d-flex"><span>Other Skills:</span> <span> Excel, Git,  Canva &amp; SEO</span></li>
									<li class="d-flex"><span>Interest:</span> <span>Coding, Travel Photography, Teaching</span></li>
						...
						<div class="counter-wrap ftco-animate d-flex mt-md-3">
							<div class="text">
								...
								<p><a href="https://www.linkedin.com/in/monis-ali/" class="btn btn-primary py-3 px-3">LinkedIn</a></p>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
    			<div class="col-md-6">
    				<div class="resume-wrap ftco-animate">
    					...
    					<span class="position">Utkal University, Bhubaneswar, Odisha</span>
    			...
    			<div class="col-md-6">
    				<div class="resume-wrap ftco-animate">
    					...
    					<span class="position">Maharishi College Of Natural Law, BBSR</span>
    					<!-- <p class="mt-4">Grade: First class distinction.</p> -->
    				</div>
				</div>
    		</div>
      ...
      <div class="container">
        ...
        <div class="row d-flex">
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <a href="https://github.com/monisali-git/SQL_Music_Store_Analysis/blob/main/Music_Store_Query.sql" target="_blank" class="block-20 zoom-effect" style="background-image: url('images/proj_1.jpg');">
              </a>
              <div class="text mt-3 float-right d-block">

                <h3 class="heading"><a href="https://github.com/monisali-git/SQL_Music_Store_Analysis/blob/main/Music_Store_Query.sql" target="_blank">Digital Music Store Data Analysis using SQL</a></h3>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
              <a href="https://github.com/monisali-git/Python_Diwali_Sales_Analysis/blob/main/Diwali_Sales_Analysis.ipynb" target="_blank" class="block-20 zoom-effect" style="background-image: url('images/Monis\ Ali\ data\ analyst\ proj_3.jpg');">
              </a>
              <div class="text mt-3 float-right d-block">

                <h3 class="heading"><a href="https://github.com/monisali-git/Python_Diwali_Sales_Analysis/blob/main/Diwali_Sales_Analysis.ipynb" target="_blank">Data Analysis using Python Project for Beginners</a></h3>
          ...
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <a href="https://github.com/monisali-git/Madhav_Store_Analysis_PowerBI/blob/main/Madhav%20Store%20dashboard.jpg" target="_blank" class="block-20 zoom-effect" style="background-image: url('images/proj_3.jpg');">
              </a>
              <div class="text mt-3 float-right d-block">

                <h3 class="heading"><a href="https://github.com/monisali-git/Madhav_Store_Analysis_PowerBI/blob/main/Madhav%20Store%20dashboard.jpg" target="_blank">Power BI Sales dashboard Project for Beginners</a></h3>
	...
	<br>
		...
		<div class="row d-flex justify-content-center">  
			<div class="col-md-4 d-flex ftco-animate">
				<div class="blog-entry justify-content-end">
					<!-- *******************************************--------------Ye photo me link add kiya gya hai ------------**************************************************************************************************************************************************************** -->
				<a href="https://github.com/monisali-git/sales_forecasting/tree/main" target="_blank" class="block-20 zoom-effect" style="background-image: url('images/proj_4.jpg');">
				</a>
				<div class="text mt-3 float-right d-block">
  
				  <h3 class="heading"><a href="https://github.com/monisali-git/sales_forecasting/tree/main" target="_blank">Sales Forecast- Time Series Forecasting</a></h3>
			...
			<div class="col-md-4 d-flex ftco-animate">
				<div class="blog-entry justify-content-end">
				<a href="https://github.com/monisali-git/customer_segmentation/blob/main/Customer_Segmentation-final.ipynb" target="_blank" class="block-20 zoom-effect" style="background-image: url('images/proj_5.jpg');">
				</a>
				<div class="text mt-3 float-right d-block">
  
				  <h3 class="heading"><a href="https://github.com/monisali-git/customer_segmentation/blob/main/Customer_Segmentation-final.ipynb" target="_blank">Customer Segmentation using clustering model</a></h3>
			  ...
			  <!-- <div class="container"> -->
				  <div class="row justify-content-center">
					  <div class="col-md-7 ftco-animate text-center">
						  ...
						  <br>
						  <p><a href="https://github.com/monisali-git" target="_blank" class="btn btn-primary py-3 px-5">GitHub</a></p>
						  </div>
					  </div>
				  </div>
			  <!-- </div> -->
		  ...
		  <div class="row d-flex contact-info mb-5">
			...
			<div class="col-md-6 col-lg-3 d-flex ftco-animate">
				<div class="align-self-stretch box p-4 text-center">
				  ...
				  <p><a href="mailto:monis.analyst@gmail.com">monis.analyst@gmail.com</a></p>
				</div>
			</div>
			<div class="col-md-6 col-lg-3 d-flex ftco-animate">
				<div class="align-self-stretch box p-4 text-center">
			  ...
			  <div class="row justify-content-center">
				  ...
				  <br>
					  <ul class="ftco-footer-social list-unstyled d-flex justify-content-center align-items-center mb-0">
						...
						<li class="ftco-animate"><a href="https://www.youtube.com/@monisali_official_30"><span class="icon-youtube"></span></a></li>
						<li class="ftco-animate"><a href="https://www.linkedin.com/in/monis-ali/"><span class="icon-linkedin"></span></a></li>  
						<li class="ftco-animate"><a href="https://twitter.com/Monis_1129"><span class="icon-twitter"></span></a></li>
						<li class="ftco-animate"><a href="https://twitter.com/Monis_1129"><span class="icon-facebook"></span></a></li>
						<li class="ftco-animate"><a href="https://www.instagram.com/monisali_official_30/"><span class="icon-instagram"></span></a></li>
					  </ul>
				  <br>
			 </div>
	 </div>
